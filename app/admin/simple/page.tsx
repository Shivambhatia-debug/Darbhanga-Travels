...
export default function SimpleAdminPage() {
  ...
  const addPassenger = () => {
    if (bookingData.passengerDetails.length >= 10) {
      toast({
  ...
  const removePassenger = (index: number) => {
    if (bookingData.passengerDetails.length === 1) {
      toast({
        title: "Cannot Remove",
    ...
    const newPassengerDetails = bookingData.passengerDetails.filter((_, i) => i !== index)
    setBookingData(prev => ({ 
      ...prev, 
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Simple admin booking system</p>
            </div>
          </div>
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <CardTitle className="text-2xl">Admin Booking System</CardTitle>
                  <p className="text-white/80 mt-1">Create bookings quickly and easily</p>
                </div>
              </div>
            </CardHeader>
              ...
              {activeStep === 1 && (
                ...
                >
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-semibold mb-2">Select Service Type</h3>
                    <p className="text-gray-600">Choose the type of booking you want to create</p>
                  </div>
              ...
              {activeStep === 2 && (
                ...
                >
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600">Enter the basic travel information</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    {bookingData.passengerDetails.map((passenger, index) => (
                      <div key={index} className="p-4 border rounded-lg bg-gray-50">
                        <div className="flex justify-between items-center mb-4">
                          ...
                          {bookingData.passengerDetails.length > 1 && (
                            <Button
                              type="button"
                              variant="ghost"
                              size="sm"
                    ...
                    <div className="flex justify-center">
                      <Button
                        ...
                        disabled={bookingData.passengerDetails.length >= 10}
                      >
