...
import { Train, ArrowLeft, Mail } from "lucide-react"
...
export default function TrainBookingPage() {
  ...
  const handleSubmitBooking = async () => {
    ...
    try {
      const totalFare = (bookingInfo.fare || 0) * parseInt(bookingInfo.passengers || '1')
      ...
      const bookingData = {
        ...
        paid_amount: 0,
        pending_amount: totalFare,
        status: 'pending',
        payment_status: 'pending',
        notes: `Train: ${bookingInfo.trainName || bookingInfo.train || "Not Selected"} (${bookingInfo.train || ''}), Class: ${bookingInfo.class}, Departure: ${bookingInfo.departureTime}, Arrival: ${bookingInfo.arrivalTime}`,
        passenger_details: bookingInfo.passengerDetails || [],
        train_number: bookingInfo.train || '',
        train_name: bookingInfo.trainName || '',
        class: bookingInfo.class || '',
        departure_time: bookingInfo.departureTime || '',
        arrival_time: bookingInfo.arrivalTime || '',
        duration: bookingInfo.duration || '',
        fare_per_person: bookingInfo.fare || 0
      }
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <CardTitle className="text-2xl">Train Booking Details</CardTitle>
            ...
            <CardContent className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p><span className="font-medium">Train:</span> {bookingInfo.train || "Not Selected"}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {bookingInfo.passengerDetails && bookingInfo.passengerDetails.map((passenger: any, index: number) => (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <p><span className="font-medium">Phone:</span> {bookingInfo.phone || 'Not provided'}</p>
                  <p><span className="font-medium">Email:</span> {bookingInfo.email || 'Not provided'}</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <p><span className="font-medium">Class:</span> {bookingInfo.class}</p>
                  <p><span className="font-medium">Fare per person:</span> ₹{bookingInfo.fare || 0}</p>
                  <p><span className="font-medium">Total Fare:</span> ₹{(bookingInfo.fare || 0) * parseInt(bookingInfo.passengers || '1')}</p>
                </div>
              </div>
