  ...
  const handleSubmitBooking = async () => {
    ...
    try {
      const bookingData = {
        ...
        notes: `Bus Type: ${bookingInfo.type || "Not Selected"}`,
        passenger_details: bookingInfo.passengerDetails,
        bus_number: bookingInfo.bus || '',
        seat_type: bookingInfo.type || ''
      }
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-t-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <CardTitle className="text-2xl">Bus Booking Details</CardTitle>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p><span className="font-medium">Bus Type:</span> {bookingInfo.type}</p>
                  </div>
                </div>
